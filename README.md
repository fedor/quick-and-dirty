...
TOC could be autogenerated and placed via `[toc]` string.
...
# Example
Check `index.md` template and two versions of a final pages: `index.html` and `private.html`. Certain parts of `private.html` are removed in "public" version.
